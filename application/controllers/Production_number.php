...
class Production_number extends CI_Controller {
    ...
    public function insert()
    {
		...
		if( $record->num_rows() > 0){ 
			...
			$update = $this->production_number_model->update($update_score); 
			...
			$insert = $this->production_number_model->insert($data);
			if($insert){ 
				$data = array(
					'response' => true,
	...
	function get_candidate_score()
	{
		...
		$get_candidate_score = $this->production_number_model->get_candidate_score($data);
	...
	function get_candidate_consolidated_score()
	{
		...
		$get_candidate_score = $this->production_number_model->get_candidate_consolidated_score($data);
	...
	function get_tot_score()
	{
		...
		$get_tot_score = $this->production_number_model->get_tot_score($data);
	...
	function get_candidate_score_consolidate($candidate_id)
	{
		...
		$arrcore = $this->production_number_model->get_candidate_score_consolidate($data);
		return $arrcore;
	...
	function get_ranking_specific_judge()
	{
		...
		$result = $this->production_number_model->get_ranking_specific_judge($data);
	...
	function get_consolidated_ranking()
	{
		...
		$result = $this->production_number_model->get_consolidated_ranking($data);
		$x = $result;
	...
	function update_rank()
	{
		...
		$update = $this->production_number_model->update_rank($data); 
	...
	function is_judge_done_scoring()
	{
		...
		$is_done = $this->production_number_model->is_judge_done_scoring($data); 
	...
	function get_candidate_rank_summary($candidate, $judge)
	{
		...
		$rank = $this->production_number_model->get_candidate_rank_summary($data); 
	...
	function get_summary_candidate_final_rank($candidate, $judge = 0)
	{
		...
		$final_rank= 0; 
		$get_final_rank = $this->production_number_model->get_summary_candidate_final_rank($data);
