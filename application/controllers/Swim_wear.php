...
class Swim_wear extends CI_Controller {
	...
	{
		// get top 3 candidate
		$candidate = $this->swim_wear_model->get_top_candidate();
	...
	function print_summary()
	{
		...
		$data['candidate'] = $this->candidate_model->get_all_candidate();
		$data['judge'] = $this->user_model->get_all_judge();  
		$this->load->view('admin/swim_wear_summary', $data);
	...
	function get_candidate_rank_summary($candidate, $judge)
	{
		...
		$rank = $this->swim_wear_model->get_candidate_rank_summary($data); 
	...
	function get_summary_candidate_final_rank($candidate, $judge = 0)
	{
		...
		$final_rank= 0; 
		$get_final_rank = $this->swim_wear_model->get_summary_candidate_final_rank($data);
