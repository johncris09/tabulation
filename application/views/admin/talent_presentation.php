    ...
    $(document).ready(function(){   
      ...
      function consolidate_rank(){
        $('.candidate-consolidate').each(function(){   
          ...
          $.ajax({
            type : 'POST',
            url : BASE_URL + "talent_presentation/get_candidate_consolidated_score",
            data : { 
      ...
      function get_tot_score(){
        $('.tot-score').each(function(){   
          ...
          $.ajax({
            type : 'POST',
            url : BASE_URL + "talent_presentation/get_tot_score",
            data : { 
              candidate : $(this).data('candidate'), 
            },
            dataType: "json",
      ...
      function load_rank(){ 
        $.ajax({
          url: BASE_URL + 'talent_presentation/get_consolidated_ranking',
          type: 'POST',   
          dataType: 'JSON',
          success: function(data){   
						...
						if (result.value) {  
							$.ajax({
								...
								success: function(data){    
									if(data){ 
									$.ajax({
										url: BASE_URL + 'talent_presentation/unlock',
										type: 'POST',   
										data: _this.data(),
										dataType: 'JSON',
										success: function(data){    
